...
namespace App\Models {
    ...
    /**
     * App\Models\DJBakaTwitchOverlay1
     *
     * @method static \Illuminate\Database\Eloquent\Builder<DJBakaTwitchOverlay1>|DJBakaTwitchOverlay1 newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DJBakaTwitchOverlay1>|DJBakaTwitchOverlay1 newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DJBakaTwitchOverlay1>|DJBakaTwitchOverlay1 query()
     ...
     */
    class DJBakaTwitchOverlay1 extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class FFXIVLogoSelected extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\FFXIVLogos
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos whereFileName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos whereVenueName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos whereLogoPath($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FFXIVLogos>|FFXIVLogos query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class FFXIVLogos extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
